...
The codes `RET` and `CALL` are unused and reserved.
...
## Register Aliases
You can use the keywords `IMR`, `IN`, `ADDR`, `DATA`, and `STACK` to reference the registers 0, 8, 9, 10, and 11 respectively.
